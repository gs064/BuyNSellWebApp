...
namespace BuyNSellWebApp.Controllers
{
    ...
    public class TypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TypeID,TypeName")] Models.Type @type)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TypeID,TypeName")] Models.Type @type)
        {
            if (id != @type.TypeID)
            {
                return NotFound();
