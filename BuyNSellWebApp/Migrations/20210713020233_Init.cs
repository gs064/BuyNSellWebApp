...
namespace BuyNSellWebApp.Migrations
{
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubTypes", x => x.SubTypeID);
                    table.ForeignKey(
            ...
            var backup = Path.Combine(".\\Backup", @"buydb.sql");
            migrationBuilder.Sql(File.ReadAllText(backup));
        }
